...
{
    public class OuEspecificacaoComInclusoes<T> : OuEspecificacaoBase<T>
    {
        public OuEspecificacaoComInclusoes(IEspecificacao<T> esquerda, IEspecificacao<T> direita)
        ...
        public override Expression<Func<T, bool>> Expressao
        {
            get
            {
                ...
                var corpo = Expression.OrElse(esquerdaBody, direitaBody);
