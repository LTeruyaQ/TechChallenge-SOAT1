...
{
    public class ObterEstoqueCriticoHandler : UseCasesAbstrato<ObterEstoqueCriticoHandler, Estoque>
    {
        ...
        public async Task<ObterEstoqueCriticoResponse> Handle(ObterEstoqueCriticoCommand command)
        {
